...
class ReceivedLikesScreen extends StatelessWidget {
  ReceivedLikesScreen({super.key});
                            ...
                            if(controller.sideBarMenusExpanded.isFalse)
                              ...[
                                ...
                                const Padding(
                                  ...
                                  child: Text(
                                    "Likes you have received from other users",
                                    style: TextStyle(
                                      fontSize: 13,
                                ...
                                Expanded(
                                  child: Container(
                                    ...
                                    child: FutureBuilder(
                                      future: controller.getReceivedLikes(),
                                      builder: (context, snapshot) {
                                        if(controller.receivedLikes.isEmpty && controller.isLoading.isTrue) {
                                          ...
                                          return Text(
                                            "You haven't received any likes",
                                            style: TextStyle(
                                              color: themeController.isDarkMode.isTrue ?
                                              ThemeData.light().scaffoldBackgroundColor:
                                              ThemeData.dark().scaffoldBackgroundColor,
